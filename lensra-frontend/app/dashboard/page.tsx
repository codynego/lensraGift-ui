...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const fetchDashboardData = async () => {
    ...
    try {
      ...
      // 2. Fetch Real Orders from the endpoint
      ...
      // Grab the most recent order for the display card
          ...
          <div className="space-y-12">
            ...
            <section className="bg-zinc-900 rounded-[32px] p-8 md:p-12 relative overflow-hidden text-white shadow-2xl">
              ...
              <div className="relative z-10">
                ...
                <h2 className="text-3xl md:text-5xl font-bold tracking-tight leading-tight mb-8 uppercase">
